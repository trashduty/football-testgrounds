...
const METRICS = {
  ...
  wepa: {
    ...
    x: "off_wepa",
    y: "def_wepa",
    xLabel: "Offensive Weighted EPA",
    yLabel: "Defensive Weighted EPA Allowed",
    reverseDefense: true,
    format: ".2f",
    quadrants: true
  },
  ...
  epa: {
    ...
    x: "off_epa",
    y: "def_epa",
    xLabel: "Offensive EPA / Play",
    yLabel: "Defensive EPA / Play Allowed",
    reverseDefense: true,
    format: ".3f",
    quadrants: true
  },
  ...
  pass_epa: {
    ...
    yLabel: "Defensive Pass EPA / Play Allowed",
    reverseDefense: true,
    format: ".3f",
    quadrants: true
  },
  ...
  rush_epa: {
    ...
    yLabel: "Defensive Rush EPA / Play Allowed",
    reverseDefense: true,
    format: ".3f",
    quadrants: true
  },
  ...
  success: {
    ...
    x: "off_success",
    y: "def_success",
    xLabel: "Offensive Success Rate",
    yLabel: "Defensive Success Rate Allowed",
    reverseDefense: true,
    format: ".1%",
    quadrants: true
  },
  ...
  proe: {
    ...
    x: "proe",
    y: "def_proe",
    xLabel: "Offensive PROE",
    yLabel: "Opponent PROE vs Defense",
    reverseDefense: false,
    format: ".1%",
    quadrants: false
  }
