...
|---|---|---|---|---|
| Florida Gators | -2.5 (-112) | BetMGM | 47.6% | <span class="btb-advice-pill btb-advice-no-bet">No Bet</span> |
| Auburn Tigers | +2.5 (+100) | BetRivers | 52.1% | <span class="btb-advice-pill btb-advice-lean">Lean – doesn&#x27;t meet our edge criteria to fully bet</span> |

## Our Take

The Florida Gators visit the Auburn Tigers at Jordan-Hare Stadium. We make **Auburn +1**, compared with a market line of +2.5.

The best number we found is Auburn +2.5 at +100. We see a 2.1% edge there, but that does not clear our 3% threshold, so we are passing.
