...
/*
 * CHANGE THIS if your BTB logo lives somewhere else.
 */
const BTB_LOGO_URL =
  "./assets/btb-logo.png";
...
function renderChart() {
  ...
  /*
   * Best and worst quadrant shading.
   */
  if (
    benchmarkX !== null &&
    benchmarkY !== null &&
  ...
  const layout = {
    ...
    title: {
      ...
      /*
       * Keep BTB Power Rating branding.
       */
      text:
        `${season} ${metric.title}`,
...
async function downloadCard(
  ...
  /*
   * Give external logos/images time
   * to finish loading.
   */
  const images =
